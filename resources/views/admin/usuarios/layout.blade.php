...
<head>
    ...
    <title>@yield('title', 'Usuarios y Permisos')</title>
    ...
    <style>
        *{ margin:0; padding:0; box-sizing:border-box; font-family:'Segoe UI',sans-serif; }
        ...
        body{
            min-height:100vh;
            background:linear-gradient(135deg,#0d3f3c,#1c7a74,#40E0D0);
            padding:30px;
        }
        ...
        .logo{ font-size:24px; font-weight:700; color:#0d3f3c; }
        ...
        .success{
            ...
            border-radius:12px; margin-bottom:20px; border-left:5px solid #22c55e;
        }
        .error{
            background:#fee2e2; color:#991b1b; padding:15px;
            border-radius:12px; margin-bottom:20px; border-left:5px solid #ef4444;
        }
...
<body>
    ...
    <nav class="navbar">
        <div class="logo">🔐 Usuarios y Permisos</div>
        <div class="nav-links">
